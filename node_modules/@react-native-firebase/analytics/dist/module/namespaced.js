...
class FirebaseAnalyticsModule extends FirebaseModule {
  ...
  initiateOnDeviceConversionMeasurementWithEmailAddress(emailAddress) {
    ...
    return this.native.initiateOnDeviceConversionMeasurementWithEmailAddress?.(emailAddress) ?? Promise.resolve();
  }
  initiateOnDeviceConversionMeasurementWithHashedEmailAddress(hashedEmailAddress) {
    ...
    return this.native.initiateOnDeviceConversionMeasurementWithHashedEmailAddress?.(hashedEmailAddress) ?? Promise.resolve();
  }
  initiateOnDeviceConversionMeasurementWithPhoneNumber(phoneNumber) {
    ...
    return this.native.initiateOnDeviceConversionMeasurementWithPhoneNumber?.(phoneNumber) ?? Promise.resolve();
  }
  initiateOnDeviceConversionMeasurementWithHashedPhoneNumber(hashedPhoneNumber) {
    ...
    return this.native.initiateOnDeviceConversionMeasurementWithHashedPhoneNumber?.(hashedPhoneNumber) ?? Promise.resolve();
  }
}
