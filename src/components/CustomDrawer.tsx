...
const MENU_ITEMS: MenuItem[] = [
  ...
  { label: 'Earnings',      screen: 'Revenue',        icon: 'bar-chart-outline',        activeIcon: 'bar-chart',        roles: ['OWNER', 'SUPER_ADMIN'] },
  { label: 'Manage Services', screen: 'ManageServices', icon: 'construct-circle-outline',  activeIcon: 'construct-circle',  roles: ['OWNER', 'SUPER_ADMIN'] },
